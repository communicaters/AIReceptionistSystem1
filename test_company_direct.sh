...
# Send a test WhatsApp message asking directly about company name
curl -X POST "http://localhost:5000/api/whatsapp/webhook/zender" -H "Content-Type: application/x-www-form-urlencoded" -d "secret=5504ae432734b5374dee41807a880284714889bd&type=whatsapp&data[id]=3932&data[wid]=+447887147178&data[phone]=+923000047478&data[message]=What company do you work for?&data[attachment]=0&data[timestamp]=1745002800"
